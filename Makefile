...
CC = ld
CC2 = gcc -nostdlib
FLAGS = -w+all -w+label-orphan

# beeing cleaned
OBJ_FOLDER0 = _obj
SRC_FOLDER = src
OBJ_FOLDER = $(SRC_FOLDER)/$(OBJ_FOLDER0)

SRC := $(shell find src -name '*.s')
OBJ := $(patsubst $(SRC_FOLDER)/%.s,$(SRC_FOLDER)/$(OBJ_FOLDER0)/%.o,$(SRC))
...
$(SRC_FOLDER)/$(OBJ_FOLDER0)/%.o: $(SRC_FOLDER)/%.s
	@mkdir -p $(dir $@)
	@if ! $(COMPIL) $< -o $@; then \
